...
const styles = {
  container: { maxWidth: '1400px', paddingTop: '0' },
  header: { 
    display: 'flex', 
  ...
  categoryTag: { display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '8px 12px', background: 'var(--accent-light)', border: '1px solid var(--border-color)', borderRadius: '20px', color: 'var(--secondary-accent)', fontSize: '14px', fontWeight: '500' },
  ...
  smallLabel: { fontSize: '11px', fontWeight: '600', color: 'var(--text-muted)' },
  ...
  testimonialNum: { fontSize: '13px', fontWeight: '600', color: 'var(--accent-color)' },
  removeBtn: { padding: '4px 12px', background: 'var(--delete-btn-bg)', border: '1px solid var(--delete-btn-border)', borderRadius: '6px', color: 'var(--delete-btn-color)', fontSize: '12px', cursor: 'pointer' },
  previewSection: { padding: '16px', background: 'var(--glass-bg)', borderRadius: '12px', textAlign: 'center' },
  previewBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 24px', background: 'var(--accent-light)', border: '1px solid var(--border-color)', borderRadius: '10px', color: 'var(--accent-color)', fontSize: '14px', fontWeight: '600', cursor: 'pointer' },
  formActions: { display: 'flex', gap: '12px', justifyContent: 'flex-end', marginTop: '8px' },
  cancelBtn: { padding: '14px 28px', borderRadius: '980px', background: 'var(--bg-secondary)', border: 'none', color: 'var(--text-primary)', fontWeight: '600', fontSize: '15px', cursor: 'pointer' },
  /* Golden Ratio Typography: 10 → 13 → 16 → 21 */
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '16px' },
  card: { overflow: 'hidden', borderRadius: '14px' },
  productImage: { position: 'relative', height: '180px', background: 'var(--bg-secondary)' },
  image: { width: '100%', height: '100%', objectFit: 'cover' },
  placeholder: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '40px', background: 'var(--bg-secondary)', color: 'var(--text-muted)' },
  badge: { position: 'absolute', top: '10px', right: '10px', padding: '4px 10px', borderRadius: '980px', fontSize: '10px', fontWeight: '600' },
  imageCountBadge: { position: 'absolute', bottom: '8px', left: '8px', padding: '3px 7px', borderRadius: '980px', fontSize: '10px', fontWeight: '600', background: 'rgba(0,0,0,0.6)', color: 'white', display: 'flex', alignItems: 'center', gap: '3px' },
  templateBadge: { position: 'absolute', top: '10px', left: '10px', padding: '4px 8px', borderRadius: '5px', fontSize: '9px', fontWeight: '700', background: 'var(--accent-color)', color: 'white', textTransform: 'capitalize' },
  cardContent: { padding: '14px 16px 16px' },
  productName: { fontSize: '13px', fontWeight: '600', marginBottom: '4px', color: 'var(--text-primary)', letterSpacing: '-0.01em', lineHeight: '1.35', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  productDesc: { fontSize: '11px', color: 'var(--text-muted)', marginBottom: '12px', lineHeight: '1.5', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' },
  productFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' },
  price: { fontSize: '14px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '1px', letterSpacing: '-0.02em' },
  stock: { fontSize: '10px', color: 'var(--text-muted)', fontWeight: '500' },
  actions: { display: 'flex', gap: '5px' },
  iconBtn: { padding: '7px', borderRadius: '7px', background: 'var(--icon-btn-bg)', border: '1px solid var(--icon-btn-border)', color: 'var(--icon-btn-color)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s' },
  deleteBtn: { padding: '7px', borderRadius: '7px', background: 'var(--delete-btn-bg)', border: '1px solid var(--delete-btn-border)', color: 'var(--delete-btn-color)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s' },
  empty: { textAlign: 'center', padding: '120px 20px' },
  emptyIcon: { fontSize: '72px', marginBottom: '24px' },
  emptyTitle: { fontSize: '28px', fontWeight: '600', marginBottom: '12px', color: 'var(--text-primary)', letterSpacing: '-0.02em' },
  emptyDesc: { fontSize: '17px', color: 'var(--text-muted)', fontWeight: '400' },
};
