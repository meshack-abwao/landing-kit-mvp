...
const styles = {
  ...
  productDesc: { fontSize: '14px', color: 'var(--text-secondary)', marginBottom: '16px', lineHeight: '1.5', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' },
  productFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' },
  price: { fontSize: '18px', fontWeight: '700', color: 'var(--accent-color)', marginBottom: '4px' },
  stock: { fontSize: '13px', color: 'var(--text-muted)' },
  ...
  emptyDesc: { fontSize: '16px', color: 'var(--text-muted)' },
};
