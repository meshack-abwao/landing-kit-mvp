...
const styles = {
  ...
  card: { overflow: 'hidden', borderRadius: '16px' },
  productImage: { position: 'relative', height: '200px', background: 'var(--bg-secondary)' },
  image: { width: '100%', height: '100%', objectFit: 'cover' },
  placeholder: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '48px', background: 'var(--bg-secondary)', color: 'var(--text-muted)' },
  badge: { position: 'absolute', top: '12px', right: '12px', padding: '5px 12px', borderRadius: '980px', fontSize: '11px', fontWeight: '600' },
  imageCountBadge: { position: 'absolute', bottom: '10px', left: '10px', padding: '4px 8px', borderRadius: '980px', fontSize: '11px', fontWeight: '600', background: 'rgba(0,0,0,0.6)', color: 'white', display: 'flex', alignItems: 'center', gap: '4px' },
  templateBadge: { position: 'absolute', top: '12px', left: '12px', padding: '5px 10px', borderRadius: '6px', fontSize: '10px', fontWeight: '700', background: 'var(--accent-color)', color: 'white', textTransform: 'capitalize' },
  cardContent: { padding: '16px 18px 18px' },
  productName: { fontSize: '15px', fontWeight: '600', marginBottom: '6px', color: 'var(--text-primary)', letterSpacing: '-0.01em', lineHeight: '1.3' },
  productDesc: { fontSize: '13px', color: 'var(--text-muted)', marginBottom: '14px', lineHeight: '1.45', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' },
  productFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' },
  price: { fontSize: '16px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '2px', letterSpacing: '-0.02em' },
  stock: { fontSize: '12px', color: 'var(--text-muted)', fontWeight: '500' },
  actions: { display: 'flex', gap: '6px' },
  iconBtn: { padding: '8px', borderRadius: '8px', background: 'var(--icon-btn-bg)', border: '1px solid var(--icon-btn-border)', color: 'var(--icon-btn-color)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s' },
  deleteBtn: { padding: '8px', borderRadius: '8px', background: 'var(--delete-btn-bg)', border: '1px solid var(--delete-btn-border)', color: 'var(--delete-btn-color)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s' },
