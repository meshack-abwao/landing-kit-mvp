...
const styles = {
  ...
  /* Golden Ratio Typography: 11 → 14 → 18 */
  ...
  productName: { fontSize: '15px', fontWeight: '600', marginBottom: '4px', color: 'var(--text-primary)', letterSpacing: '-0.01em', lineHeight: '1.35', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  ...
  price: { fontSize: '15px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '1px', letterSpacing: '-0.02em' },
  stock: { fontSize: '11px', color: 'var(--text-muted)', fontWeight: '500' },
