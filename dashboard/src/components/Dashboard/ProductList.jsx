...
const styles = {
  ...
  card: { overflow: 'hidden', borderRadius: '18px' },
  productImage: { position: 'relative', height: '220px', background: 'var(--bg-secondary)' },
  image: { width: '100%', height: '100%', objectFit: 'cover' },
  placeholder: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '56px', background: 'var(--bg-secondary)', color: 'var(--text-muted)' },
  badge: { position: 'absolute', top: '16px', right: '16px', padding: '6px 14px', borderRadius: '980px', fontSize: '12px', fontWeight: '600' },
  imageCountBadge: { position: 'absolute', bottom: '12px', left: '12px', padding: '4px 10px', borderRadius: '980px', fontSize: '12px', fontWeight: '600', background: 'rgba(0,0,0,0.6)', color: 'white', display: 'flex', alignItems: 'center', gap: '4px' },
  templateBadge: { position: 'absolute', top: '16px', left: '16px', padding: '6px 12px', borderRadius: '8px', fontSize: '11px', fontWeight: '600', background: 'var(--accent-color)', color: 'white' },
  cardContent: { padding: '24px' },
  productName: { fontSize: '19px', fontWeight: '600', marginBottom: '8px', color: 'var(--text-primary)', letterSpacing: '-0.01em' },
  productDesc: { fontSize: '14px', color: 'var(--text-muted)', marginBottom: '20px', lineHeight: '1.5', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' },
  productFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' },
  price: { fontSize: '17px', fontWeight: '600', color: 'var(--text-primary)', marginBottom: '4px', letterSpacing: '-0.01em' },
  stock: { fontSize: '13px', color: 'var(--text-muted)', fontWeight: '400' },
  actions: { display: 'flex', gap: '8px' },
  iconBtn: { padding: '10px', borderRadius: '10px', background: 'var(--icon-btn-bg)', border: '1px solid var(--icon-btn-border)', color: 'var(--icon-btn-color)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s' },
  deleteBtn: { padding: '10px', borderRadius: '10px', background: 'var(--delete-btn-bg)', border: '1px solid var(--delete-btn-border)', color: 'var(--delete-btn-color)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s' },
