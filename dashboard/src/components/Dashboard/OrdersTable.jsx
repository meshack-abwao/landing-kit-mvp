...
const styles = {
  ...
  loadingContainer: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 20px', gap: '16px', color: 'var(--text-muted)' },
  spinner: { width: '40px', height: '40px', border: '3px solid var(--border-color)', borderTop: '3px solid var(--accent-color)', borderRadius: '50%', animation: 'spin 1s linear infinite' },
  ...
  refreshBtn: { padding: '12px', background: 'var(--icon-btn-bg)', border: '1px solid var(--icon-btn-border)', borderRadius: '10px', color: 'var(--icon-btn-color)', cursor: 'pointer' },
  exportBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 20px', background: 'var(--accent-light)', border: '1px solid var(--border-color)', borderRadius: '10px', color: 'var(--accent-color)', fontSize: '14px', fontWeight: '600', cursor: 'pointer' },
  ...
  statLabel: { fontSize: '12px', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '4px' },
  statValue: { fontSize: '24px', fontWeight: '800', color: 'var(--text-primary)' },
  ...
  filterTab: { padding: '8px 16px', background: 'var(--icon-btn-bg)', border: '1px solid var(--icon-btn-border)', borderRadius: '20px', color: 'var(--text-muted)', fontSize: '13px', fontWeight: '600', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' },
  filterTabActive: { background: 'var(--accent-light)', borderColor: 'var(--accent-color)', color: 'var(--accent-color)' },
  filterCount: { background: 'var(--bg-secondary)', padding: '2px 8px', borderRadius: '10px', fontSize: '11px' },
  empty: { padding: '80px 40px', textAlign: 'center' },
  emptyIcon: { fontSize: '64px', marginBottom: '20px' },
  emptyTitle: { fontSize: '24px', fontWeight: '700', marginBottom: '8px', color: 'var(--text-primary)' },
  emptyText: { fontSize: '16px', color: 'var(--text-muted)' },
  ...
  productNameMobile: { fontWeight: '600', marginBottom: '4px', color: 'var(--text-primary)' },
  orderQty: { fontSize: '13px', color: 'var(--text-muted)' },
  orderCustomer: {},
  customerName: { fontWeight: '600', marginBottom: '8px', color: 'var(--text-primary)' },
  customerActions: { display: 'flex', gap: '8px', flexWrap: 'wrap' },
  actionBtn: { display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 12px', background: 'var(--icon-btn-bg)', border: '1px solid var(--icon-btn-border)', borderRadius: '8px', color: 'var(--icon-btn-color)', fontSize: '13px', cursor: 'pointer' },
  orderCardFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '16px', borderTop: '1px solid var(--border-color)' },
  orderTotal: { fontSize: '20px', fontWeight: '700', color: 'var(--accent-color)', display: 'block' },
  orderDate: { fontSize: '12px', color: 'var(--text-muted)' },
  statusSelectMobile: { padding: '10px 14px', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', borderRadius: '10px', color: 'var(--text-primary)', fontSize: '14px' },
  tableContainer: { padding: '0', overflowX: 'auto' },
  table: { width: '100%', borderCollapse: 'collapse', minWidth: '900px' },
  tableHeader: { borderBottom: '1px solid var(--border-color)' },
  th: { padding: '16px', textAlign: 'left', fontSize: '12px', fontWeight: '700', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px', whiteSpace: 'nowrap' },
  tableRow: { borderBottom: '1px solid var(--border-color)', transition: 'background 0.2s' },
  td: { padding: '16px', fontSize: '14px', color: 'var(--text-secondary)', whiteSpace: 'nowrap' },
  orderId: { fontFamily: 'monospace', fontSize: '13px', color: 'var(--accent-color)' },
  productCell: { display: 'flex', alignItems: 'center', gap: '12px', color: 'var(--text-primary)' },
  productThumb: { width: '40px', height: '40px', borderRadius: '8px', objectFit: 'cover' },
  contactCell: { display: 'flex', gap: '8px' },
  contactBtn: { padding: '8px', background: 'var(--icon-btn-bg)', border: '1px solid var(--icon-btn-border)', borderRadius: '8px', color: 'var(--icon-btn-color)', cursor: 'pointer' },
  price: { fontWeight: '700', color: 'var(--accent-color)' },
  payment: { fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' },
  ...
  statusSelect: { padding: '8px 12px', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', borderRadius: '8px', color: 'var(--text-primary)', fontSize: '13px', cursor: 'pointer' },
};
