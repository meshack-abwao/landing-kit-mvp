...
const styles = {
  ...
  sectionContent: { paddingTop: '16px', borderTop: '1px solid var(--border-color)', marginTop: '16px' },
  cardTitle: { fontSize: '20px', fontWeight: '700', margin: 0 },
  cardDesc: { fontSize: '14px', color: 'var(--text-secondary)', marginBottom: '20px' },
  formGroup: { marginBottom: '20px' },
  formRow: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' },
  label: { fontSize: '12px', fontWeight: '700', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '10px', display: 'block' },
  optional: { fontSize: '10px', fontWeight: '400', color: 'var(--text-muted)', textTransform: 'none' },
  inputDisabled: { background: 'var(--glass-bg)', color: 'var(--text-muted)', cursor: 'not-allowed' },
  hint: { fontSize: '12px', color: 'var(--text-muted)', fontStyle: 'italic', marginTop: '6px' },
  ...
  fontDesc: { fontSize: '11px', color: 'var(--text-muted)' },
  saveBtn: { display: 'flex', alignItems: 'center', gap: '8px', marginTop: '8px' },
  // Testimonial styles
  testimonialCard: { padding: '16px', background: 'var(--glass-bg)', border: '1px solid var(--border-color)', borderRadius: '12px', marginBottom: '16px' },
  testimonialHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' },
  testimonialNum: { fontSize: '14px', fontWeight: '600', color: 'var(--text-secondary)' },
