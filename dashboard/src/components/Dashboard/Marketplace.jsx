...
const styles = {
  ...
  hint: { fontSize: '12px', color: 'rgba(255, 255, 255, 0.4)', fontStyle: 'italic' },
  paymentInfo: { padding: '20px', background: 'rgba(255, 255, 255, 0.03)', borderRadius: '12px', display: 'flex', flexDirection: 'column', gap: '12px' },
  infoRow: { display: 'flex', justifyContent: 'space-between', fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)' },
  amount: { fontWeight: '600', color: 'white' },
  totalRow: { paddingTop: '12px', borderTop: '1px solid rgba(255, 255, 255, 0.1)', fontSize: '16px', fontWeight: '700' },
  ...
  cardDesc: { fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)', lineHeight: '1.6' },
  ...
  benefitItem: { display: 'flex', alignItems: 'flex-start', gap: '10px', fontSize: '14px', lineHeight: '1.5', color: 'rgba(255, 255, 255, 0.8)' },
  ...
  cardFooter: { display: 'flex', flexDirection: 'column', gap: '16px', paddingTop: '16px', borderTop: '1px solid rgba(255, 255, 255, 0.1)' },
  pricing: { display: 'flex', alignItems: 'baseline', gap: '4px' },
  price: { fontSize: '28px', fontWeight: '800', color: '#ff9f0a' },
  period: { fontSize: '14px', color: 'rgba(255, 255, 255, 0.5)' },
  footerActions: { display: 'flex', gap: '12px', justifyContent: 'space-between', alignItems: 'center' },
  learnMoreBtn: { display: 'flex', alignItems: 'center', gap: '6px', padding: '10px 16px', background: 'rgba(255, 255, 255, 0.05)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '10px', color: 'rgba(255, 255, 255, 0.7)', fontSize: '14px', fontWeight: '600', cursor: 'pointer', transition: 'all 0.3s' },
