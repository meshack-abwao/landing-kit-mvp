    ...
    <div className="dashboard-container">
      ...
      <aside className={`dashboard-sidebar glass-card ${mobileMenuOpen ? 'mobile-open' : ''}`}>
        ...
        <nav style={styles.nav}>
          <NavLink to="/dashboard" end className={({ isActive }) => isActive ? 'nav-link active-nav' : 'nav-link'} onClick={handleNavClick}>
            <Home size={20} /><span>Overview</span>
          </NavLink>
          <NavLink to="/dashboard/products" className={({ isActive }) => isActive ? 'nav-link active-nav' : 'nav-link'} onClick={handleNavClick}>
            <Package size={20} /><span>My Products</span>
          </NavLink>
          <NavLink to="/dashboard/templates" className={({ isActive }) => isActive ? 'nav-link active-nav' : 'nav-link'} onClick={handleNavClick}>
            <LayoutGrid size={20} /><span>Templates</span>
          </NavLink>
          <NavLink to="/dashboard/orders" className={({ isActive }) => isActive ? 'nav-link active-nav' : 'nav-link'} onClick={handleNavClick}>
            <ShoppingCart size={20} /><span>Orders</span>
          </NavLink>
          <NavLink to="/dashboard/marketplace" className={({ isActive }) => isActive ? 'nav-link active-nav' : 'nav-link'} onClick={handleNavClick}>
          ...
          <NavLink to="/dashboard/settings" className={({ isActive }) => isActive ? 'nav-link active-nav' : 'nav-link'} onClick={handleNavClick}>
